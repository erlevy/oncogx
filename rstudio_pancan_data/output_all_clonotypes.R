...
exome_dir <- '/Users/Eric/tcrseq/old/imseq/'
...
colnames(clonotypes_all) <- c("clonotype", "aa", "patient_id", "blood", "rna", "exome")
exome_clonotypes <- c()
rna_clonotypes <- c()
blood_clonotypes <- c()
...
write.table(clonotypes_exome, "clonotypes_exome_pancan.txt", sep="\t", quote=FALSE, row.names=FALSE)

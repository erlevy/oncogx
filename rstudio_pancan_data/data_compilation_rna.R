...
gsva_file <- ""
clinical_file <- ""
results <- matrix(NA, nrow=nrow(rna_ref), ncol=43)
...
write.table(results, "/Users/Eric/tcrseq/new/processed/pancan_exome_rna_blood_tcrb_gsva_clinical_7-29-2016_RNA.txt", sep="\t", 

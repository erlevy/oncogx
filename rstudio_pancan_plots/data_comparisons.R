...
results_exome <- read.csv("/Users/Eric/tcrseq/new/processed/pancan_exome_rna_blood_tcrb_gsva_clinical_7-29-2016_exome.txt", sep="\t")
results_RNA <- read.csv("/Users/Eric/tcrseq/new/processed/pancan_exome_rna_blood_tcrb_gsva_clinical_7-29-2016_RNA.txt", sep="\t")
...
write.table(results_both, "/Users/Eric/tcrseq/new/processed/pancan_exome_rna_blood_tcrb_gsva_clinical_7-29-2016.txt", sep="\t", 
